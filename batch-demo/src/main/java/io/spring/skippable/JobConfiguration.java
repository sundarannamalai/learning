...
public class JobConfiguration {
  ...
  public Job parallelJob(JobBuilderFactory jobBuilderFactory, StepBuilderFactory stepBuilderFactory) throws Exception {
    return jobBuilderFactory.get("skippableJob")
        .start(skipTest(stepBuilderFactory))
        .build();
  }
  ...
  @Bean
  public Step skipTest(StepBuilderFactory stepBuilderFactory) throws Exception {
    return stepBuilderFactory.get("skipStep")
        ...
        .faultTolerant()
        .skip(CustomProcessingException.class)
        .skip(CustomWriterException.class)
        .skipLimit(10)
        .build();
  }
